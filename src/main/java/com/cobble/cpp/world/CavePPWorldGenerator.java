...
public class CavePPWorldGenerator implements IWorldGenerator {

	public MapGenBase caveGenerator = new MapGenBase();
	...
	private void generateSurface(World world, Random random, int x, int z) {
		this.addOreSpawn(CavePPBlocks.stlactite, world, random, x, z, 16,
				16, 4 + random.nextInt(3), 100, 5, 50);
	}
